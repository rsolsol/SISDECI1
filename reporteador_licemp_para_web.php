...
<body>
    <section class="lateral">
        <div class="perfil">
            ...
            <a class="botonera" href="reporteador_licemp_completo.php">Reporte Desarrollo Economico Completo</a><br>
        </div>
    </section>    
    <div class="registro">
    <section class="proyectos">
          <header class="proyecto__titulo">
           <h2>Bienvenido al Reporteador de Licencias de Funcionamientos</h2>
            ...
            <h2>Listado de Licencias de Funcionamientos Emitidos para subir al Portal Web</h2>
            <form action="reporte_licemp_para_web.php" >
