...
<body>
    ...
    <section class="proyectos">
       ...
       <form action="ga_lic_civil.php" name="formulario" id="formulario" method="post" class="row" enctype="multipart/form-data">
           ...
           <div class="giros_grupos">
              ...
              <?php 
                    ...
                    $v_descripcion_grupo = $result_row3['descripcion_grupo'];
               ?>    
               <input type="text" name="grupo" id="grupo" value="<?php echo utf8_encode($v_descripcion_grupo); ?>" disabled>
           ...
           <label for="observaciones" hidden="hidden">Observaciones</label>
            ...
            <div class="aprobacion">
                <label for="res_defcivil" hidden="hidden">Resolucion de ITSC</label>
                <input type="text" name="res_defcivil" id="res_defcivil" placeholder="Ingrese la Resolucion de ITSC" autofocus required>
                
                <label for="num_cert_defcivil"></label>
                <input type="text" name="num_cert_defcivil" id="num_cert_defcivil" placeholder="Ingrese el numero del Certificado" required>
            </div>
