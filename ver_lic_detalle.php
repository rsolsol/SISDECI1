<?php
//require_once ("Negocio/general.class.php");
//$ver = new clase_procesos();
?>
...
//                 $sql = "SELECT * FROM licencias_defcivl WHERE id_grupo = $menu and acepto_desarecon='9' and acepto_defcivil='9' and estado= '1'";     
//               }
//            
...
//fin de la rutina antigua para buscar licencias ingresadas//            
                ...
                //instanciamos en $db la clase de conexcion
                $db= new MySQL();
                $sql ="SELECT * FROM lic_solicitud where id_cest in('3') and nnumero_exp_sol like '%2016' ORDER BY ID_SOLICITUD_SOL DESC;";
                $result = $db->consulta($sql);
                $result_row = $db->fetch_assoc($result);
                $result_row_num = $db->num_rows($result);
            ...
            <table width="100%" border="0" cellspacing="2" cellpadding="2">
                <tr>
                    ...
                    <td colspan="3" width="15%" align="center" bgcolor="#FFFF99">Acciones</td>
                </tr>
                <?php
                ...
                <tr>
                    ...
                    <td align="center" bgcolor="#E6E6E6"><strong><a href="http://localhost:8080/proyecto1/<?php  echo $result_row['img_voucher']; ?>" target="_blank">Ver</a></strong></td>
