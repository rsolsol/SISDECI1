...
//fin de la rutina antigua para buscar licencias ingresadas//            
                ...
                $sql ="SELECT * FROM lic_solicitud a 
                       ...
                       inner join lic_desa_econo c
                       on c.id_solicitud_sol  =a.ID_SOLICITUD_SOL
                       where b.id_solicitud_sol  is null 
                       and  d.id_def_civl is null
                       and id_cest in('1') and right(nnumero_exp_sol,4) = '2016' 
            ...
            <table width="100%" border="0" cellspacing="2" cellpadding="2">
                ...
                <tr>
                    ...
                    <td align="center" bgcolor="#E6E6E6"><strong>
                        <a href="desaprobar_def_civil.php?nNUMERO_EXP_SOL=<?php  echo $expediente; ?>&ID_SOLICITUD_SOL=<?=$id_solicitud?>">&nbsp;&nbsp;Desaprobar</a></strong></td>
                </tr>
                <?php
                }
