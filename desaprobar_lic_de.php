...
{
    $v_obser_desa = $_POST['obser_desaprobar'];


    $sql ="insert into lic_desaeco_desaprobar(id_solicitud_sol,obser_desaprobar,fecha_desaeco_desaprobar,estado_desaeco_desaprobar)
values ('$sol','$v_obser_desa',NOW(),1);";
...
<body>
    ...
    <section class="proyectos">
          <header class="proyecto__titulo">
           <h2>Ingrese la solicitud para el desaprobar la Licencia</h2>
          </header>
       <form name="formulario" id="formulario" method="post" class="row" enctype="multipart/form-data">
           ...
           <div class="domicilio">
            ...
            <div class="aprobacion">
                ...
                <input type="text" name="obser_desaprobar" id="obser_desaprobar" placeholder="Ingrese la sustentación para desaprobar" autofocus required>
            </div>
...
<?php header("Location: ver_lic_de_eco.php"); ?>
